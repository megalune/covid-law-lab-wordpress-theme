	...
	array( "name" => "nav-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Theme Stylesheet",
				   ...
				   "type" => "select",
				   "std" => "default.css",
				   "options" => array("default.css", "green.css", "red.css"),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Enable social incons on the secondary menu",
				   "id" => $shortname."_nav_social_enable",
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => "desc",),	
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "nav-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Enable headline news ticker",
				   "id" => $shortname."_headline_news_enable",
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => "desc",),

			array( "name" => "Number of headline news to display",
                   "id" => $shortname."_headline_news_num",
                   "type" => "text",
                   "std" => "3",
				   "desc" => "Here you can choose the number of posts to display on headline news ticker."),					   

			array( "name" => "Input comma-separated tags for the headline news",
				   "id" => $shortname."_headline_news_tags",
				   "type" => "text",
				   "std" => "headline, top",
				   "desc" => "desc",),				   

			array( "name" => "Choose header style",
                   "id" => $shortname."_header_style",
                   "type" => "select",
                   "std" => "Header with Quotes",
				   "desc" => "Here you can choose the style of site header.",
                   "options" => array("Header with Quotes", "Header with Advertisement")),
				   
			array( "name" => "Left quote image",
				   "id" => $shortname."_header_left_quote_img",
				   "type" => "upload",
				   "std" => get_bloginfo('template_directory') . '/images/cameron.png',
				   "desc" => "Image size: 93 x 93px",),
				   
			array( "name" => "Left quote text in bold",
				   "id" => $shortname."_header_left_quote_bold",
				   "type" => "text",
				   "std" => "David Cameron",
				   "desc" => "desc",),

			array( "name" => "Left quote text",
				   "id" => $shortname."_header_left_quote",
				   "type" => "text",
				   "std" => "Nemo enim ipsam voluptatem",
				   "desc" => "desc",),

			array( "name" => "Right quote image",
				   "id" => $shortname."_header_right_quote_img",
				   "type" => "upload",
				   "std" => get_bloginfo('template_directory') . '/images/obama.png',
				   "desc" => "Image size: 93 x 93px",),				   			   
				   
			array( "name" => "Right quote text in bold",
				   "id" => $shortname."_header_right_quote_bold",
				   "type" => "text",
				   "std" => "Barack Obama",
				   "desc" => "desc.",),

			array( "name" => "Right quote text",
				   "id" => $shortname."_header_right_quote",
				   "type" => "text",
			...
			array( "name" => "Input comma-separated tags for the featured content",
				   "id" => $shortname."_featured_post_tags",
				   "type" => "text",
				   "std" => "featured, breaking",
				   "desc" => "desc",),		      			   

			array( "name" => "Exclude categories from the column #1",
				   "id" => $shortname."_column1_cats",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "desc",
				   "usefor" => "categories",
			...
			array( "name" => "Number of posts to show per category",
				   "id" => $shortname."_column1_post_num",
				   "type" => "text",
				   "std" => "4",
				   "desc" => "desc"),					   				   

			array( "name" => "Choose posts to display on Column #2",
                   "id" => $shortname."_column2_posts_type",
                   "type" => "select",
                   "std" => "Latest Posts",
				   "desc" => "Here you can choose posts to display on Column #2. You can choose between Featured Posts and Latest Posts.",
                   "options" => array("Latest Posts", "Featured Posts")),	              			   				   		   
		...
		array( "name" => "layout-2",
			...
			array( "name" => "Show thumbnails on archive page",
                   "id" => $shortname."_show_archive_thumb",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "desc. "),
				   
			array( "name" => "Number of characters to show per post",
            	   "id" => $shortname."_archive_char_num",
            	   "type" => "text",
                   "std" => "240",
			       "desc" => "desc"),
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Show related articles & social connections on posts",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Enable header ad (468x60)",
				   "id" => $shortname."_header_ad_enable",
				   	"type" => "checkbox",
				   "std" => "false",
				   "desc" => "To show this AD block, you need to enable the 'Header with advertisement' option on Layout Settings.",),

			array( "name" => "Enable column #1 ad (300x250)",
				   "id" => $shortname."_column1_ad_enable",
				   	"type" => "checkbox",
				   "std" => "false",
				   "desc" => "You could enable / disable an AD block (300x250) on column #1.",),   				   
			...
			array( "name" => "Input column #1 ad code",
				   "id" => $shortname."_column1_ad_code",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "desc",),		   				   
