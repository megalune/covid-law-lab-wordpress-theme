...
window.location.href = "/instruments/instrument-region/"+selectedCategories[0];
...
if(document.URL.indexOf("sort=wpcf-iyoa&sortorder=") !=-1){
order = document.URL.substring(document.URL.indexOf("sort=wpcf-iyoa&sortorder=")+27,document.URL.indexOf("sort=wpcf-iyoa&sortorder=")+30)
if(order=="DES"){
order = "DESC";
}
order  = "?sort=wpcf-iyoa&sortorder="+order;
}
...
for(var j =0; j<selectedCategories.length;j++){
	...
	window.location.href = "/instruments/instrument-region/"+tempURL + "/" + order;

	} else	if(tempURL!=""){
	window.location.href = "/instruments/instrument-region/"+tempURL+"+"+ SlugArray[CatArray[id]] + "/" + order;
	} else {
	window.location.href = "/instruments/instrument-region/"+ SlugArray[CatArray[id]] + "/" + order;
	}
