...
(function() {
  ...
  FusionTipOverlay.prototype.onAdd = function() {
    ...
    div.style.backgroundColor = "#A3CCE8";
    div.style.fontSize = 'small';
    div.style.filter  = 'alpha(opacity=.060)';
      ...
      if (data) {
        ...
        if (numRows > 0) {
          ...
          for (i = 0; i < numCols; i++) {
            ...
            html += "Country: "+data.rows[0][i] + "<br/>";
            } else if(data.cols[i]=="Judgements"){
	                html += "No of Judgements: "+data.rows[0][i] + "<br/>";
            }
             else if(data.cols[i]=="Category"){
	            html += "Category: "+data.rows[0][i] ;
	    }
