...
if(selectedCategoriesLabel!=""){
	document.getElementById("clear_label").innerHTML = "<li style='float:left;'><a href='javascript:void(0);' onclick='reload();'><b>Clear Filters</b></a></li>" ;
...
window.location.href = "/constitutions/constitution-region/"+selectedCategories[0];
...
if(document.URL.indexOf("sort=wpcf-cyoa&sortorder=") !=-1){
order = document.URL.substring(document.URL.indexOf("sort=wpcf-cyoa&sortorder=")+27,document.URL.indexOf("sort=wpcf-cyoa&sortorder=")+30)
if(order=="DES"){
order = "DESC";
}
order  = "?sort=wpcf-cyoa&sortorder="+order;
}
...
for(var j =0; j<selectedCategories.length;j++){
	...
	window.location.href = "/constitutions/constitution-region/"+tempURL + "/" + order;

	} else	if(tempURL!=""){
	window.location.href = "/constitutions/constitution-region/"+tempURL+"+"+ SlugArray[CatArray[id]] + "/" + order;
	} else {
	window.location.href = "/constitutions/constitution-region/"+ SlugArray[CatArray[id]] + "/" + order;
	}
