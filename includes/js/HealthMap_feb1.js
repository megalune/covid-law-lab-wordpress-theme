            ...
            google.maps.event.addListener(country, 'mouseout', function() {
              ...
              this.setOptions({fillOpacity: 1});
                  	...
                  	google.maps.event.addListener(country, 'dbclick', function(event) {
				        ...
				        //if(categoryId !=null){
				        window.location.href = "http://https://www.globalhealthrights.org/category/"+Region.toLowerCase()+"/"+Country.toLowerCase().replace(' ','-').replace(' ','-').replace(' ','-')+"/?cat="+categoryId+"&sort=wpcf-j-year&order=DESC";
					...
					//if(categoryId !=null){
				        window.location.href = "/category/"+Region.toLowerCase()+"/"+Country.toLowerCase().replace(' ','-').replace(' ','-').replace(' ','-')+"/?cat="+categoryId+"&sort=wpcf-j-year&order=DESC";
				  	//} else {
