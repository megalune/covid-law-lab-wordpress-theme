...
/*initilize function*/
 ...
 map.setMapTypeId('custom_map_style');
	...
	document.getElementById("category_label").innerHTML = "<li style='float:right;'><a href='#' onclick='loadmap(null);'><b>Clear Filter</b></a></li><li style='float:right;'><a href='#' style='cursor:default;background-color:white;'><b>"+category+"</b></a></li>";
